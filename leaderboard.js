...
function renderKoStandings(combinedStandings, koResults, bracketData, koLiveData = {}) {
  ...
  const _scoringTooltipHtml = `<div class="scoring-info-anchor" id="scoring-info-anchor"><span class="scoring-info-link">Scoring ⓘ</span><div class="scoring-tooltip-box"><div class="stt-row"><span>Group Stage</span><span class="stt-pts">2</span></div><div class="stt-row"><span>Round of 32</span><span class="stt-pts">4</span></div><div class="stt-row"><span>Round of 16</span><span class="stt-pts">8</span></div><div class="stt-row"><span>Quarterfinals</span><span class="stt-pts">12</span></div><div class="stt-row"><span>Semifinals</span><span class="stt-pts">16</span></div><div class="stt-row"><span>3rd place</span><span class="stt-pts">12</span></div><div class="stt-row"><span>Final</span><span class="stt-pts">24</span></div><div class="stt-tb-title">Tiebreakers</div><ul class="stt-tb-list"><li>Correct champion pick</li><li>Total correct picks</li><li>Still tied? Stay tied.</li></ul></div></div>`;
  document.getElementById('koStandingsSection').innerHTML = `
