...
**Color classes** (% of participants correct) — configured in `PILL_TIERS` at the top of `leaderboard.js`:
- ≥ 80% "Consensus": `.cp-hi` — `#d4f0fb` bg / `#00628a` text
- 21–79% "Middle": `.cp-mid` — `#fff0d0` bg / `#a05800` text
- ≤ 20% "Contrarian": `.cp-lo` — `#fce0e7` bg / `#b3003d` text
